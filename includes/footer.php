        ...
        <div>
          ...
          <nav aria-label="Meny sidfot">
            <ul>
              ...
              <li><a href="<?php echo VANLIGAFRAGOR?>">Vanliga Frågor <i class="fas fa-angle-double-right"></i></a></li>
        ...
        <div>
          ...
          <ul>
            ...
            <li><i class="fas fa-external-link-alt"></i> <a href="http://www.funkaportalen.se/guide/Stod-service/Resor/"
                target="_blank">Stiftelsen Funka - Resor</a></li>
            <li><i class="fas fa-external-link-alt"></i> <a
                href="https://www.sll.se/verksamhet/kollektivtrafik/fardtjansten/" target="_blank">Region Stockholm -
                Färdtjänsten</a></li>
            <li><i class="fas fa-external-link-alt"></i> <a
